...
public class ManIntersectionOfHandler extends AbstractTagValueHandler {

    HashMap<String, ManOBORelation> relations = null ;

    public ManIntersectionOfHandler(OBOConsumer consumer, HashMap<String, ManOBORelation>relations) {
